...
map_columns = ['id','userId','date','content','longitude','latitude', 'placeId', 'inReplyTo','source','truncated','placeLatitude','placeLongitude'
               , 'sourceName','sourceUrl','userName','screenName','followers','friends','statusesCount','userLocation']
